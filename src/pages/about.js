    ...
    <div>
      ...
      <div className="">
        ...
        <header className="flex items-center px-8 md:px-20 lg:px-32 py-5 font-medium bg-[#f3f4f6] space-x-4">
          ...
          <p className="text-skin-muted">Biz Haqimizda</p>
        </header>
          ...
          <section className="max-w-7xl mx-auto px-8 lg:px-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center py-10">
              ...
              <div className="space-y-3">
                <h3 className="text-2xl lg:text-4xl font-medium text-skin-main">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-7 py-8 items-center">
              <div className="flex space-x-3 items-center">
                ...
                <div className="space-y-3">
                  <h3 className="text-xl md:text-2xl font-semibold text-skin-base">
                    Bizning Maqsadimiz
                  </h3>
            ...
            <div className="pt-10">
              <div className="text-center">
                <h1 className="text-2xl md:text-4xl py-4 text-skin-base font-semibold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-10">
              <div className="space-y-3">
                ...
                <p className="text-skin-muted text-sm font-semibold">
              ...
              <div className="hover:scale-105 transform transition duration-300 relative">
                ...
                />
                <img
                  className="absolute -top-8 md:-top-10 right-0 sm:right-20 md:right-0 lg:right-10 xl:right-32 rounded-full w-20 md:w-24 lg:w-32"
            ...
            <div className="items-center justify-around  sm:pb-6  rounded-md">
              <div className="sm:text-center lg:text-left">
                ...
                <div className="flex text-skin-main text-2xl lg:text-4xl transition-all duration-300 font-semibold sm:justify-center lg:justify-start">
