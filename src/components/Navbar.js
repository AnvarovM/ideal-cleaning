...
const Navbar = () => {
  ...
  const renderChangeTheme = () => {
    ...
    if (currentTheme === "dark") {
      ...
      return (
        <MoonIcon
          className="w-8 h-8 text-[#5a606d] text-skin-dark_text_muted"
          role="button"
        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center md:space-x-1">
            ...
            <div
              ...
              className="relative p-2 hover:bg-gray-300 dark:hover:bg-white rounded-3xl"
            >
              ...
              >
                ...
                <div
                  ...
                  className="flex items-center cursor-pointer space-x-2 mb-1"
                >
                  <ReactCountryFlag
            ...
            <div className="relative">
              {sesssion ? (
                ...
                <div
                  onClick={() => setOpenUser(!openUser)}
                  className="flex items-center md:space-x-1 py-2 px-2 md:px-3 md:bg-gray-200 hover:bg-gray-300 md:dark:bg-white rounded-3xl"
                >
